...
import { BreakEven } from "@/components/site/break-even";
import { MODELS, profitCurve, simulate, type ModelId } from "@/lib/simulator";
      ...
      <div className="mx-auto max-w-6xl px-5 py-20 md:py-28">
        <Reveal>
          ...
          <p className="mt-4 max-w-xl text-sm leading-relaxed text-fog">
            사업모델 정책안의 5기 운영 테이블을 보간한 값입니다. 충전기 수·월 사용량·kWh 요금을 바꿔 복지형·수익형을 비교해 보세요.
          </p>
        </Reveal>

        <p className="mt-10 text-xs tracking-widest text-fog uppercase">연간 손익</p>
        <div className="mt-4 grid gap-6 lg:grid-cols-12">
          <div className="rounded-2xl bg-ink p-5 shadow-border md:p-6 lg:col-span-5">
            ...
            <ClientOnly
              fallback={
                <div className="mt-5 h-40 rounded-xl bg-ink-3/50" />
              }
            >
